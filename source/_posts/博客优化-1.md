...
8. [git 克隆指定分支代码_git clone -b-CSDN博客](https://blog.csdn.net/wudinaniya/article/details/104125961)
...
[git推送代码报错：fatal: The current branch master has no upstream branch. To push the current branch and set the remote as upstream - Amerys - 博客园 (cnblogs.com)](https://www.cnblogs.com/Amerys/p/14669572.html)
...
注意不是克隆库，而是需要克隆分支。（因为我按照参考资料1使用分支保存源文件）

使用git拉代码时可以使用 -b 指定分支指定拉 master 分支代码

```
git clone -b master http://github.com/narrciss/narrciss.github.io
```
